                ...
                <td>
                  <div class="dropdown d-inline">
                    ...
                    <div class="dropdown-menu">
                      <a href="{{ route('lpfk.orderDetail', ['id' => $order->id]) }}" class="dropdown-item has-icon"><i
                          class="fas fa-info-circle text-info"></i> Detail</a>
                      @if (!$order->approved_by_kepala)
                        <a href="{{ route('lpfk.accept', ['id' => $order->id]) }}" class="dropdown-item has-icon" id="btn-confirm"><i
