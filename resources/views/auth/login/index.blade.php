      ...
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            ...
            <div class="text-center text-small text-dark footer">
              Copyright &copy; 2022 - <a class="text-dark" target="_blank" href="vendor/team-portfolio/index.html">BPFK Banjarbaru</a>
            </div>
        ...
        <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" style="background-size: cover"
          data-background="{{ asset('assets/img/bg/login-bg.jpg') }}">
          <div class="absolute-bottom-left index-2">
            <div class="text-light p-5 pb-2">
              <div class="mb-5 pb-3">
                <h1 class="mb-2 display-4 font-weight-bold">BPFK Banjarbaru</h1>
                <h5 class="font-weight-normal text-muted-transparent">Banjarbaru, Kalimantan Selatan</h5>
              </div>
